...
| [0010](0010-validation-and-error-handling.md)| Validation and error handling              | accepted | ApiError shape, 400 vs 404, domain→HTTP mapping, FE ErrorBanner surfacing          |
